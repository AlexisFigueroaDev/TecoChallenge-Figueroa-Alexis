...
export const GET_NEW_FORECAST_START = 'forecast:GET_NEW_FORECAST_START';
export const GET_NEW_FORECAST_SUCCESS = 'forecast:GET_NEW_FORECAST_SUCCESS';
export const GET_NEW_FORECAST_ERROR = 'forecast:GET_NEW_FORECAST_ERROR';
